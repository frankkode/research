        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "study_group",
                    models.CharField(
                        choices=[("PDF", "PDF Group"), ("CHATGPT", "ChatGPT Group")],
                        max_length=10,
                    ),
                ),
                ...
                ("consent_completed_at", models.DateTimeField(blank=True, null=True)),
                ("pre_quiz_completed_at", models.DateTimeField(blank=True, null=True)),
                (
                    "interaction_completed_at",
                    models.DateTimeField(blank=True, null=True),
                ),
                ("post_quiz_completed_at", models.DateTimeField(blank=True, null=True)),
                ("study_completed_at", models.DateTimeField(blank=True, null=True)),
